 ...
 <div class="contenedor-principal" id="principal">
    <main>
        <div class="contenedor-divisor">    
            ...
            <h1>Bienvenido a la sección de profesores</h1> 
    ...
    switch($direccion) {
        ...
        case "añadir_profesor":
        include_once("admin_includes/añadir_profesor.php");
        break;

        case "editar_profesor":
        include_once("admin_includes/editar_profesor.php");
        break;
        ...
        default:
        include_once("admin_includes/ver_profesores.php");
        break;
